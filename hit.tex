...
path constructors are not written as a constructor of path type.
Instead, they specify the endpoints (or \textit{edges}) of a path directly.
...
straightforward, like the \text{square} constructor of $T^2$:
